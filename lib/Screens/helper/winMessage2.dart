...
class CongratulationsDialog2 extends StatefulWidget {
  final int selectedValue;

  CongratulationsDialog2({required this.selectedValue});

  @override
  _CongratulationsDialog2State createState() => _CongratulationsDialog2State();
}

class _CongratulationsDialog2State extends State<CongratulationsDialog2> {
